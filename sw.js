...
const urlsToCache = [
  ...
  '/salonmujervirtuosa/calendar.html',
  ...
  '/salonmujervirtuosa/utils/push-config.js',
  '/salonmujervirtuosa/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/salonmujervirtuosa/icons/icon-192x192.png',
    badge: '/salonmujervirtuosa/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/salonmujervirtuosa/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/salonmujervirtuosa/admin.html';
  event.waitUntil(
